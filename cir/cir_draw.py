...
def draw_item_options(item, grid, MOUSE_POS):
    ...
    for option in item.options:
        ...
        draw_hover(option.pos, MOUSE_POS, grid)


def draw_menu_buttons(MOUSE_POS, grid):
    ...
    for button in grid.buttons:
        ...
        draw_hover(button.pos, MOUSE_POS, grid)


def draw_body(item, MOUSE_POS, grid):
    ...
    draw_hover(item.pos, MOUSE_POS, grid)

def draw_timers(grid, my_body):
...
def draw_hover(tile, MOUSE_POS, grid):
